#!/usr/bin/env python3
"""Check current local SQLite database for data"""
from sqlalchemy import create_engine, inspect, text

# Check the current tales.db
DATABASE_URL = "sqlite:////Users/rachelkremen/Documents/Code/tales_project/tales.db"

print(f"Checking current local database (tales.db)...")
